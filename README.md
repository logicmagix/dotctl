...
| **mako**      |   ✓   |  ✓   |  ✓   |                                                               |
| **wofi**      |   ✓   |  ✓   |  ✓   | subvariant (1/2)                                              |
| **waybar**    |   ✓   |  ✓   |  ✓   | style, scope, decor, cpu, cputemp, ram, gpu, vram, vpn, battery, audio, power, launcher, transparent, opacity, launcher logo, editor |
| **hypr**      |   ✓   |      |      | window effect (shadow/glow)                                   |
| **wallpaper** |   ✓   |      |      | cycle script per theme                                        |

Everything lives in one 34-field, hand-editable state file at
